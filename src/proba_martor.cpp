...
void ProbaMartor::descriere() const {
    cout<<"Proba martor: "<<denumire<< ", Credibilitate: "<<(credibilitate ? "Da" : "Nu")<<", Relevanta declaratie: "<<relevantaDeclaratie<<"/10, Valida: "<<(valida ? "Da" : "Nu");
}
